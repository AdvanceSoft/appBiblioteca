package appbiblioteca.c1_presentacion.util;
...
public abstract class Mensaje {
    ...
    private static final String MENSAJE_ARRIBA = "Software Biblioteca";
    ...
    private static final String MENSAJE_EXEDECANTIDADPERMITIDA = "La cantidad es mayor a la exedida";
    private static final String MENSAJE_HABILITADO = "El Lector esta habilitado para prestamo";
    private static final String MENSAJE_NOHABILITADOPORSANCION = "El Lector esta desabilitado para realizar Prestamo";
    private static final String MENSAJE_NOHABILITADOPORPRESTAMO = "El Lector tiene un Prestamo pendiente";
    ...
    public static void Mostrar_MENSAJE_EXEDECANTIDADPERMITIDA(JDialog dialogo,String mensaje) {
        JOptionPane.showMessageDialog(dialogo, mensaje,MENSAJE_EXEDECANTIDADPERMITIDA,JOptionPane.ERROR_MESSAGE);
    }
    
    public static void Mostrar_MENSAJE_HABILITADO(JDialog dialogo,String mensaje) {
         JOptionPane.showMessageDialog(dialogo, mensaje,MENSAJE_HABILITADO,JOptionPane.INFORMATION_MESSAGE);
    }
    
    public static void Mostrar_MENSAJE_NOHABILITADOPORSANCION(JDialog dialogo,String mensaje) {
        JOptionPane.showMessageDialog(dialogo, mensaje,MENSAJE_NOHABILITADOPORSANCION,JOptionPane.ERROR_MESSAGE);
    }
    
    public static void Mostrar_MENSAJE_NOHABILITADOPORPRESTAMO(JDialog dialogo,String mensaje) {
        JOptionPane.showMessageDialog(dialogo, mensaje,MENSAJE_NOHABILITADOPORPRESTAMO,JOptionPane.ERROR_MESSAGE);
    }
}